...
linkIconsAnnimation = ()=>{
  ...
  icn[4].style.left = (adj-62) +'px'; icn[4].p = [0,23,(adj-38),32,1600]
  for (const c of icn) {
...
var ctx = document.getElementById("headerCanvas").getContext("2d")
lineAnnimation = ()=>{
  ...
  for (var i = 25; i <= window.innerWidth-15; i+=25) {
    lines.addLine({
      ...
      x1: i, y1: 3, x2: i, y2: 3, ex: i, ey: random(46,50)
    })
  }
  lines.draw()
}
